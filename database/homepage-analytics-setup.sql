-- Homepage Analytics Setup
-- This script adds homepage tracking to the existing analytics system
...
-- Policy: Only admins can view homepage analytics
...
-- Policy: Allow system to insert homepage analytics data
...
BEGIN
    ...
    IF table_exists THEN
        RAISE NOTICE '✅ Table homepage_visits created successfully';
    ELSE
        RAISE EXCEPTION '❌ Table homepage_visits was not created';
    END IF;
    
    IF function_exists THEN
        RAISE NOTICE '✅ Function get_homepage_traffic_sources created successfully';
    ELSE
