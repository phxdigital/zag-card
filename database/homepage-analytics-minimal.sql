-- Homepage Analytics - Setup Mínimo
-- Este script adiciona apenas o que está faltando, sem recriar objetos existentes
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE '✅ Table homepage_visits created';
    ELSE
        RAISE NOTICE 'ℹ️ Table homepage_visits already exists';
    END IF;
END $$;
...
-- ============================================
-- CRIAR FUNÇÕES (SEMPRE RECRIAR PARA ATUALIZAR)
-- ============================================
...
BEGIN
    ...
    RAISE NOTICE '   1. Inject tracking script in homepage';
    RAISE NOTICE '   2. Configure conversion goals';
    RAISE NOTICE '   3. Test with real traffic';
END $$;
