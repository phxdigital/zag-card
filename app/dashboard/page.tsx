                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                            ...
                            <div className="mt-6 space-y-4 max-w-sm mx-auto">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="card-text" placeholder="Seu Nome ou Empresa" value={config.cardText} onChange={(e) => handleConfigChange('cardText', e.target.value)} className="w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm disabled:bg-slate-100" disabled={!config.isTextEnabled}/>
                                </div>
                            ...
                            <div style={{backgroundColor: config.cardBackBgColor}} className="card-preview mx-auto rounded-xl shadow-lg p-4 border relative overflow-hidden">
                             ...
                             <div className="mt-6 space-y-4 max-w-sm mx-auto">
                                ...
                                <div>
                                    ...
                                    <div className="flex">
                                        <input type="text" id="subdomain" placeholder="sua-empresa" value={subdomain} onChange={(e) => setSubdomain(e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, ''))} className="w-full px-3 py-2 border border-slate-300 rounded-l-md shadow-sm"/>
