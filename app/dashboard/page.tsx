                ...
                <main id="workspace">
                    ...
                    {activeStep === 2 && (
                        <div>
                         ...
                         <div className="mt-8 flex justify-center">
                             <button onClick={handleSaveAll} disabled={isSaving} className="w-full max-w-md bg-green-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-green-700 disabled:bg-green-400">
                 ...
                 <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-lg space-y-4">
                        ...
                        <div className="w-full h-64 bg-slate-100">
                            <img ref={cropperImageRef} alt="Imagem para recortar" src={logoDataUrl || ''} className="max-w-full"/>
                        </div>
                        <div className="flex justify-end gap-4 pt-4">
