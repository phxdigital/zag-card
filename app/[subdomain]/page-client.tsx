...
import { 
    ...
    Star, Image as ImageIcon, Video
} from 'lucide-react';
import { PageConfig, SocialLinks, CustomLink } from './page';
        ...
        >
            <div className="w-full max-w-md mx-auto text-center">
                <img 
                    ...
                    style={{
                        width: `${config.landingPageLogoSize || 96}px`, 
                        height: `${config.landingPageLogoSize || 96}px`
                    }}
                />
